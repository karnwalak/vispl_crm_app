...
<div class="container-fluid">
    ...
    <div class="row counters">
        ...
        <?php if ($leadeditata->status == 'Open') { ?>
            <form method="post" action="{{ route('updateduplicate')}}" class="pb-3 form-fields">
                ...
                <div class="row">
                    <div class="form-group remove-botttom-space col-6">
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control datetimepicker" id="lead_date" name="lead_date" placeholder="Lead Date" value="" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group remove-botttom-space col-6">
