					 ...
					 <!-- Project Card Example -->
                                <div class="card shadow  mb-4">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h1 class="m-0 font-weight-bold text-primary head-font-size">Edit Department</h1>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive data-list">
                                            <form action="{{ SITEURL }}admin/updatedepartment" method="post" class="pb-3 form-fields">                                
                                        <div class="row">
                                            <div class="form-group remove-botttom-space col-12">
                                                <div class="input-group">
                                                    <label for="inputFirstName">Department</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="designation" value="{{ $departmentdata->name }}" name="designation"  placeholder="Region Name" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right">
											<input type="hidden" name="editid" value="{{ $departmentdata->id }}">
